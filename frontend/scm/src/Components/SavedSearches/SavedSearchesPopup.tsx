    ...
    return (
        <div>
            <button onClick={() => setShowPopup(true)}
                    className={`btn px-4 btn-sm ${props.action === "delete" ? "bg-danger hover:bg-danger" : "bg-primary hover:bg-primary"} border-0 text-white rounded-8 font-semibold hover:scale-105 transition ml-3`}
            >
